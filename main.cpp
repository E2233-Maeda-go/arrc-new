...
#include "sbdbt.hpp"
//-----------------
#define kp0 0.000002//0.0006
#define ki0 0.0000002//0.00001
#define kd0 0.0000000//0.00001

#define kp 0.0000003//0.0004
...
if(A and 270 <= raw_yaw and raw_yaw <= 360){
    ...
    if(suuzi == 0)theta = 0;
        t_theta = atan2(x,y)*180/pai;
        printf("%f\n",t_theta);
        tar[0] = -(-sin(t_theta - theta) + cos(t_theta - theta));
        tar[1] = -(sin(t_theta - theta) - cos(t_theta - theta));
        for(int i = 0; i < 2; i++)
        {
